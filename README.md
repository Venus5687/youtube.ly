...
# Known bugs
The app may display "original sound" with the wrong creator's name in the track name (fixed for versions that use the "v2" endpoint, like version 4.5.0).\
Login does not work (fixed).\
Placeholder top tracks crash the app (comments have been fixed, and they're not placeholders anymore).
# Known working and not working app versions
3.0.1: working\
4.0.0: working\
4.4.5: working\
4.5.0: working\
...
Flex 2 if your iOS version is 7 or 8, or Flex 3 if your iOS version is 9 (download it [here](http://getdelta.co/packages/Flex3_3~Beta98.deb) (this is not piracy as it's free, **BEFORE INSTALLING THIS DEB, MAKE SURE YOU HAVE ORG.SWIFT.LIBSWIFT INSTALLED!**))\
